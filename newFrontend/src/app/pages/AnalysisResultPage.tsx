...
import { type Finding, type Analysis } from "../lib/mockData";
...
export function AnalysisResultPage() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        setIsLoading(true);
        const [analysisData, findingsData] = await Promise.all([
          analysisApi.getAnalysis(id),
          analysisApi.getFindings(id)
        ]);
              ...
              <Card className="lg:col-span-2 border-l-4 border-green-500">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex gap-2 pt-2">
                    <Button variant="outline" size="sm" className="flex-1" onClick={() => id && analysisApi.downloadReport(id)}>
              ...
              <CardHeader>
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                    ...
                    <Button variant="outline" size="sm" onClick={() => id && analysisApi.downloadCSV(id)}>
                      <Download className="w-4 h-4 mr-2" />
                      Export CSV
                    </Button>
                  </div>
                          ...
                          >
                            ...
                            <TableCell className="text-center">
                              <Badge
                                variant="secondary"
                                className={
                                  finding.exposure === "NETWORK" || finding.exposure === "HIGH"
                                    ? "bg-red-100 text-red-700"
                                    : finding.exposure === "FILE" || finding.exposure === "MEDIUM"
